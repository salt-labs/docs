...
Layer 4. Security Policies, Conformance, Test/Bench, Build Security (wrap CI/CD,SCM, Runtime Security, Observability.

Layer 3. CNI, CSI, CR, Cert-Manager, Service Proxy, Auth, Backup
...
Layer eXternal. CI/CD, SCM

<!-- UPLOAD DIAGRAM HERE -->

## Platform

The underlying platform is the foundation of the platform and is the first stage in the decision tree.
...
Examples: Docker, containerd, CRI-O, gVisor, Kata Containers.
