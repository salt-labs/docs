...
# Event Returner
# Specifiy the returner(s) to use to log events.
#event_return:
#  - syslog
#  - elasticsearch
#  - slack
...
# SSH Scan Ports
# Comma seperated list of ports to scan for SSH servers
ssh_scan_ports: 22
...
# Git Pillar Branch
# If the branch is ommited, default to this
